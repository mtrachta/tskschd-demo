...
let ContactController = class ContactController {
    constructor(srv) {
        this.srv = srv;
        this.logger = new common_1.Logger('ContactController');
...
], ContactController.prototype, "createItem", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ContactController.prototype, "getItemCount", null);
__decorate([
    (0, common_1.Get)(),
    ...
    __metadata("design:paramtypes", [get_contact_filter_dto_1.GetContactFilterDto,
        auth_entity_1.User]),
    __metadata("design:returntype", Promise)
], ContactController.prototype, "getItems", null);
__decorate([
    (0, common_1.Get)('/:id'),
    ...
    __metadata("design:returntype", Promise)
], ContactController.prototype, "getItem", null);
__decorate([
    (0, common_1.Patch)('/:id'),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:paramtypes", [String, update_contact_dto_1.UpdateContactDto,
        auth_entity_1.User]),
    __metadata("design:returntype", Promise)
], ContactController.prototype, "updateItem", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String, auth_entity_1.User]),
    __metadata("design:returntype", Promise)
], ContactController.prototype, "deleteItem", null);
