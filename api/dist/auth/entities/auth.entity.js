...
__decorate([
    (0, typeorm_1.OneToMany)((_type) => task_entity_1.Task, (task) => task.user),
    __metadata("design:type", Array)
], User.prototype, "tasks", void 0);
__decorate([
    (0, typeorm_1.OneToMany)((_type) => note_entity_1.Note, (note) => note.user),
    __metadata("design:type", Array)
], User.prototype, "notes", void 0);
__decorate([
    (0, typeorm_1.OneToMany)((_type) => contact_entity_1.Contact, (contact) => contact.user),
    __metadata("design:type", Array)
], User.prototype, "contacts", void 0);
__decorate([
    (0, typeorm_1.OneToMany)((_type) => activity_entity_1.Activity, (activity) => activity.user),
    __metadata("design:type", Array)
