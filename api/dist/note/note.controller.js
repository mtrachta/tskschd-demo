...
const get_note_filter_dto_1 = require("./dto/get-note-filter.dto");
let NoteController = class NoteController {
    constructor(srv) {
        this.srv = srv;
        this.logger = new common_1.Logger('NoteController');
...
], NoteController.prototype, "createItem", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], NoteController.prototype, "getItemCount", null);
__decorate([
    (0, common_1.Get)(),
    __param(0, (0, common_1.Query)()),
    __param(1, (0, get_user_decorator_1.GetUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [get_note_filter_dto_1.GetNoteFilterDto,
        auth_entity_1.User]),
    __metadata("design:returntype", Promise)
], NoteController.prototype, "getItems", null);
__decorate([
    (0, common_1.Get)('/:id'),
    ...
    __metadata("design:returntype", Promise)
], NoteController.prototype, "getItem", null);
__decorate([
    (0, common_1.Patch)('/:id'),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:paramtypes", [String, update_note_dto_1.UpdateNoteDto,
        auth_entity_1.User]),
    __metadata("design:returntype", Promise)
], NoteController.prototype, "updateItem", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String, auth_entity_1.User]),
    __metadata("design:returntype", Promise)
], NoteController.prototype, "deleteItem", null);
